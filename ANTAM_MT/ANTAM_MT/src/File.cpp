...
void set_fname() {
	...
	sprintf(mouse_filename, "mouse_%d_%d_%d_%d", t_st->tm_mon + 1, t_st->tm_mday, t_st->tm_hour, t_st->tm_min);
	sprintf(main_filename, "main_%d_%d_%d_%d", t_st->tm_mon + 1, t_st->tm_mday, t_st->tm_hour, t_st->tm_min);
